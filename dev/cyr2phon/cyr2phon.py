...
_XML_RE = re.compile(r"<line[^>]*?>(<stress>[\p{Letter}]</stress>|[^<>]+)+</line>")  # include latin
...
_PROCLITICS = {"а", "без", "бЕз", "безо", "благодаря", "близ", "блИз", "в", "вне", "во", "вО", "для", "до", "за", 
               "зА", "и", "из", "Из", "из-за",
               "из-под", "изо", "или", "иль", "к", "ко", "кО", "меж", "на", "нА", "над", "надо", "не", "нЕ", "ни", 
               "нИ", "но", "о", "О", "об", "Об", 
               "обо", "от", "ото", "перед", "передо", "по", "пО", "по-за", "по-над", "по-под", "под", "пОд", "подо", "пред",
               "предо", "при", "прИ", "про", "прО", "с", "сквозь", "скрозь", "со", "сО", "среди", "средь", "у", 
               "через", "чрез"}

"""constant for _enclitics()"""
# FIXME: pronouns may be proclitic or enclitic; need more nuanced handling
_ENCLITICS = {"бо", "бы", "же", "ли", "ль", "я", "ты", "он", "мы", "вы"}
