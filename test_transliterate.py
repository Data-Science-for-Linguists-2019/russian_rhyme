...
keySet = {"ильИничн", "здрАвствуй", "лЕстн", "мЕстн", "очЕчник", "^чтО", "^что", "никИтичн", "скУчно$", "грУстн",
...
def test_lexical_data_size():
    ...
    assert_equal(len(djb_library._lexical_data), keyLength)
